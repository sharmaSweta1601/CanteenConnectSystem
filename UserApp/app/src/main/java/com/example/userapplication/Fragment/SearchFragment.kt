...
class SearchFragment : Fragment() {
    ...
    private val originalMenuFoodName = listOf("Burger", "sandwich", "manchurian", "item")
    private val originalMenuItemPrice = listOf("40Rs", "30Rs", "20Rs", "10Rs")
